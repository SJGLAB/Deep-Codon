...
class Data:
    ...
    def generate_instance(self, name):
        ...
        if name == "train":
            ...
            self.raw_texts, self.raw_Ids = read_test(self.raw_dir, self.word_alphabet, self.char_alphabet, self.feature_alphabets, self.label_alphabet, self.number_normalized, self.MAX_SENTENCE_LENGTH)
        else:
